    ...
    <div class="col-md-4 mb-3">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <p class="text-muted">${student.educationLevel}</p>
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">${student.user.phone}</div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4 fw-bold">Địa chỉ:</div>
                    <div class="col-md-8">${student.user.address}</div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4 fw-bold">Trình độ học vấn:</div>
                    <div class="col-md-8">${student.educationLevel}</div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4 fw-bold">Mục tiêu học tập:</div>
                    <div class="col-md-8">${student.studyGoals}</div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4 fw-bold">Liên hệ phụ huynh:</div>
                    <div class="col-md-8">${student.parentContact}</div>
                </div>
            </div>
        </div>
    </div>
