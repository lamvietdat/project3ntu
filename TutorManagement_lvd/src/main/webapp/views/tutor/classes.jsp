...
<head>
    ...
    <title>Lớp học của tôi - Trung tâm Gia sư LVD</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/tutor/classes.css">
</head>
<body>
    <!-- Thanh điều hướng -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="${pageContext.request.contextPath}/tutor/classes?action=view&classId=${classInfo.classId}" class="btn btn-info">
                                                <i class="bi bi-eye"></i>
                                            </a>
    ...
    <script>
        function filterByStatus() {
            ...
            if (status) {
                window.location.href = "${pageContext.request.contextPath}/tutor/classes?status=" + status;
            } else {
                window.location.href = "${pageContext.request.contextPath}/tutor/classes";
            }
        }
